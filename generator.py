                ...
                if score == len(demos):
                    ...
                    if first != '':
                        ...
                        if last != '':
                            ...
                            name_sort = st.multiselect('Choose question(s) to sort by name, if any [default: sort by value]', list(df.columns)[first_idx: last_idx + 1], col_search(df[first_idx: last_idx + 1], key="[LIKERT]"))
